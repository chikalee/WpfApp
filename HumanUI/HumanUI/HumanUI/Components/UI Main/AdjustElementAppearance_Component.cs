...
namespace HumanUI.Components.UI_Main
{
    ...
    public class AdjustElementAppearance_Component : GH_Component
    {
        ...
        {
            if (WindowInfo.SharedWindow != null) WindowInfo.SharedWindow.Invoke(new Action(() => ColorTextElementInternal(f, fgCol, bgCol, fontSize)));
            else ColorTextElementInternal(f, fgCol, bgCol, fontSize);
        }



        //color a UIElement. Runs through a list of possible types it recognizes and tries to color/format appropriately. 
        private static void ColorTextElementInternal(UIElement f, System.Drawing.Color? fgCol, System.Drawing.Color? bgCol, double fontSize)
        {
            // create brushes
