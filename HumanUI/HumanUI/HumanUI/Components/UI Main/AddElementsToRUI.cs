...
namespace HumanUI.Components.UI_Main
{
    ...
    public class AddElementsToRUI : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the AddElements_Component class.
        /// </summary>
        public AddElementsToRUI()
            : base("AddElementsToRUI", "AddElementsToRUI",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager[0].DataMapping = GH_DataMapping.Flatten; // doesn't make sense to pass trees of elements to one window
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            var mw = WindowInfo.SharedWindow;
            if (mw != null)
            {
                ...
                if (DoVLChecking)
                {
                    ...
                    var AllSources = HUI_Util.SourcesRecursive(Params.Input[0], ActiveObjects);
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("{73b5e187-345d-1111-8495-9e06b429bc07}");
