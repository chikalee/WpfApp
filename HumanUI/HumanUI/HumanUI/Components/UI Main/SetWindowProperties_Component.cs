    ...
    public class SetWindowProperties_Component : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (DA.GetData<int>("Theme", ref theme))
            {
                ...
                {
                    case 0:
                        ThemeManager.Current.ChangeTheme(mw, "Light");
                        break;
                    case 1:
                        ThemeManager.Current.ChangeTheme(mw, "Dark");
                        break;
                    default:
            ...
            if (DA.GetData<string>("Accent Color", ref colorName))
            {
               ...
               Theme currStyle = ThemeManager.Current.DetectTheme(mw);

                ThemeManager.Current.ChangeTheme(mw,currStyle);
            }
